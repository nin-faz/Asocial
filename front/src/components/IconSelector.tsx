...
const IconSelector: React.FC<IconSelectorProps> = ({
  ...
  const iconOptions: IconOption[] = [
    ...
    { name: "PawPrint", component: <PawPrint className="h-full w-full" /> },
    { name: "Crown", component: <Crown className="h-full w-full" /> },
    { name: "Gamepad", component: <Gamepad className="h-full w-full" /> },
    { name: "Smile", component: <Smile className="h-full w-full" /> },
    { name: "Rocket", component: <Rocket className="h-full w-full" /> },
