...
type Documents = {
    ...
    "\n  query GetTop1User {\n    getTop1User {\n      id\n      top1BadgeMessage\n      top1BadgeColor\n      top1BadgePreset\n    }\n  }\n": typeof types.GetTop1UserDocument,
...
const documents: Documents = {
    ...
    "\n  mutation CreateBubble($title: String!) {\n    createBubble(title: $title) {\n      code\n      success\n      message\n      bubble {\n        id\n        title\n        author {\n          id\n          username\n          iconName\n        }\n        messages {\n          id\n          content\n          author {\n            id\n            username\n            iconName\n          }\n          dislikes\n          createdAt\n        }\n        createdAt\n        updatedAt\n      }\n    }\n  }\n": types.CreateBubbleDocument,
    "\n  mutation AddMessageToBubble($bubbleId: ID!, $content: String!) {\n    addMessageToBubble(bubbleId: $bubbleId, content: $content) {\n      id\n      content\n      author {\n        id\n        username\n        iconName\n      }\n      dislikes\n      createdAt\n    }\n  }\n": types.AddMessageToBubbleDocument,
    "\n  mutation DeleteBubble($id: ID!) {\n    deleteBubble(id: $id) {\n      code\n      success\n      message\n    }\n  }\n": types.DeleteBubbleDocument,
    ...
    "\n  query GetBubbles($limit: Int, $offset: Int) {\n    getBubbles(limit: $limit, offset: $offset) {\n      id\n      title\n      author {\n        id\n        username\n        iconName\n      }\n      messages {\n        id\n        content\n        author {\n          id\n          username\n          iconName\n        }\n        dislikes\n        createdAt\n      }\n      createdAt\n      updatedAt\n    }\n  }\n": types.GetBubblesDocument,
    "\n  query GetBubbleById($id: ID!) {\n    getBubbleById(id: $id) {\n      id\n      title\n      author {\n        id\n        username\n        iconName\n      }\n      messages {\n        id\n        content\n        author {\n          id\n          username\n          iconName\n        }\n        dislikes\n        createdAt\n      }\n      createdAt\n      updatedAt\n    }\n  }\n": types.GetBubbleByIdDocument,
    "\n  query GetBubbleMessages($bubbleId: ID!) {\n    getBubbleMessages(bubbleId: $bubbleId) {\n      id\n      content\n      author {\n        id\n        username\n        iconName\n      }\n      dislikes\n      createdAt\n    }\n  }\n": types.GetBubbleMessagesDocument,
