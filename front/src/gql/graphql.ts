...
export type AddArticleDislikeMutation = {
  __typename?: "Mutation";
  addArticleDislike?: {
    __typename?: "Dislike";
    id: string;
...
export type DeleteArticleDislikeMutation = {
  __typename?: "Mutation";
...
export type AddCommentDislikeMutation = {
  __typename?: "Mutation";
  addCommentDislike?: { __typename?: "Dislike"; id: string } | null;
};
...
export type DeleteCommentDislikeMutation = {
  __typename?: "Mutation";
...
export type CreateUserMutation = {
  ...
  createUser: {
    ...
    success: boolean;
    message: string;
    user?: { __typename?: "UserSummary"; username: string } | null;
  };
};
...
export type FindArticleByIdQuery = {
  __typename?: "Query";
  findArticleById?: {
    __typename?: "Article";
    id: string;
...
export type FindArticleByMostDislikedQuery = {
  __typename?: "Query";
  findArticleByMostDisliked?: Array<{
    __typename?: "Article";
    id: string;
    title?: string | null;
    content: string;
    ...
    dislikes?: Array<{ __typename?: "Dislike"; id: string } | null> | null;
  } | null> | null;
};
...
export type FindArticlesByUserQuery = {
  __typename?: "Query";
  findArticlesByUser: Array<{
    __typename?: "Article";
    id: string;
    title?: string | null;
    content: string;
...
export type FindDislikesByUserIdForArticlesQuery = {
  __typename?: "Query";
  getDislikesByUserIdForArticles?: Array<{
    __typename?: "Dislike";
    user?: { __typename?: "User"; id: string; username: string } | null;
    article?: {
      __typename?: "Article";
...
export type FindDislikesByUserIdForCommentsQuery = {
  __typename?: "Query";
  getDislikesByUserIdForComments?: Array<{
    __typename?: "Dislike";
    user?: { __typename?: "User"; id: string; username: string } | null;
    comment?: {
      __typename?: "Comment";
      ...
      content: string;
      createdAt?: string | null;
      author: { __typename?: "User"; username: string; id: string };
    } | null;
  } | null> | null;
};
...
>;
export const AddArticleDislikeDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "AddArticleDislike" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  AddArticleDislikeMutation,
  AddArticleDislikeMutationVariables
>;
export const DeleteArticleDislikeDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "DeleteArticleDislike" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  DeleteArticleDislikeMutation,
  DeleteArticleDislikeMutationVariables
>;
export const AddCommentDislikeDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
  ...
  AddCommentDislikeMutation,
  AddCommentDislikeMutationVariables
>;
export const DeleteCommentDislikeDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "DeleteCommentDislike" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  DeleteCommentDislikeMutation,
  DeleteCommentDislikeMutationVariables
>;
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "userUpdateBody" },
            },
          },
        },
      ],
...
export const FindArticleByIdDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "FindArticleById" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
...
>;
export const FindArticleByMostDislikedDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
  ...
  FindArticleByMostDislikedQuery,
  FindArticleByMostDislikedQueryVariables
>;
export const FindArticlesByUserDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "FindArticlesByUser" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
export const FindDislikesByUserIdForArticlesDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "FindDislikesByUserIdForArticles" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "getDislikesByUserIdForArticles" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "userId" },
  ...
  FindDislikesByUserIdForArticlesQuery,
  FindDislikesByUserIdForArticlesQueryVariables
>;
export const FindDislikesByUserIdForCommentsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "getDislikesByUserIdForComments" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "userId" },
  ...
  FindDislikesByUserIdForCommentsQuery,
  FindDislikesByUserIdForCommentsQueryVariables
>;
